...
<head>
    ...
    <link rel="stylesheet" href="{{url('css/styles2.css')}}">
</head>
<body>
...
<nav class="navbar">
    ...
    <div class="img-container">
        <img src="https://static.wixstatic.com/media/11062b_4989637a82034fa288055deda20c1f41~mv2.jpg/v1/fill/w_882,h_225,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/11062b_4989637a82034fa288055deda20c1f41~mv2.jpg" alt="Gamer Workspace">
    </div>
    <div class="content">
        <h1>BE THE FIRST TO KNOW!</h1>
        <p>At TechnoBirds, we are committed to providing the latest computer parts such as GPUs, system units, CPUs, video cards, and peripherals. Subscribe to our newsletter today to stay up-to-date with our latest products and deals. Don't miss out on the opportunity to upgrade your computer and take it to the next level!</p>
        <span class="second-par"><p>Join our community of tech-savvy individuals and introverted tech enthusiasts. Don't worry, we understand the struggles of social interaction, that's why we created this space to connect with fellow techies and share our passion for technology.</p></span>
    </div>
    <div class="input-container1">
        <input type="text" class="text" name="username" id="username" placeholder="Enter your Name">
        <input type="text" class="text" name="email" id="email" placeholder="Enter your email">
